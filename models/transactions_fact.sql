...
WITH cost_table AS (
        ...
        SELECT 
            ...
            coalesce(transactionfeesdiscount_aibyte_transform_aibyte_transform::float, 0)                               as transaction_discount,
            coalesce(employeefeesdiscount::float + transactionfeesdiscount_aibyte_transform_aibyte_transform::float, 0) as discount,
            NULL                                                                      as entity,
            NULL                                                                      as protocol,
            NULL                                                                      as price,
...
LEFT JOIN {{source('dbt-dimensions', 'clients_dimension')}} cd ON ed.clientid = cd.clientid
